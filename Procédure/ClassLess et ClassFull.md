...
La classe A, B et C sont utilisable
<br>
...
c'est la méthode qui as était mise en place lors de la création d'internet mais rapidement, cela n'a pas suffit à combler tout les besoin mondiaux; il à donc fallut innové et le **classless** est né !

## classless 

l'ICANN à donc défini certaines plage d'addresses à usage Privée pouvant être utilisé à plusieurs endroit tant que ce n'est pas sur le WAN: <br>
